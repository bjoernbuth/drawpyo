...
file_name = "example_01.drawio"

file = file_path / file_name

# %%
# Add a page
# mistake / https://merrimanind.github.io/drawpyo/usage/basic_usage/
...
temp = drawpyo.diagram.Object(template_object=data, value="Water temperature", page=page)
...
bean_mass = drawpyo.diagram.Object(template_object=data, value="Mass of beans (g)", page=page)
...
## Preheat
row_n = row_n + 1
preheat_opt = drawpyo.diagram.Object(template_object=decision, value="Preheat cone?", page=page)
...
## Start Pouring
pour_quant = drawpyo.diagram.Object(template_object=data, value="Pour quantity/count", page=page)
...
## Wait for drawdown
row_n = row_n + 1
drawdown = drawpyo.diagram.Object(template_object=process, value="Wait for drawdown", page=page)
