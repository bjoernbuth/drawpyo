...
for waypoint in waypoints:
    ...
    item_2.position = (origin[0] + 2 * h_spacing, origin[1] + v_spacing)

    link = drawpyo.diagram.Edge(page=page, source=item_1, target=item_2, waypoints=waypoint)

    origin = (origin[0], origin[1] + v_spacing * 2)


# same but translated to the right
origin = (10, 10)
for waypoint in waypoints:
    item_1 = drawpyo.diagram.Object(page=page, template_object=obj, value="wapyoints")
    item_1.position = origin
    item_2 = drawpyo.diagram.Object(page=page, template_object=obj, value="bjoerns_" + waypoint)
...
#     link = drawpyo.diagram.Edge(page=page, source=item_1, target=item_2, connection=connection)
...
#     link = drawpyo.diagram.Edge(page=page, source=item_1, target=item_2, pattern=pattern)
